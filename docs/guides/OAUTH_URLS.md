...
3. Copy the production URL (usually `timeline.solutions`)
...
- Privacy Policy: `https://timeline.solutions`
- Terms of Service: `https://timeline.solutions`
...
3. **Common formats**
   - `https://timeline.solutions` (most common)
...
If you want to use a custom domain like `timeline.solutions` or `timeline.solutions`:
