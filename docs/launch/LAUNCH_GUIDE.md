...
2. Search for your domain (e.g., `timeline.solutions`, `timeline.solutions`)
...
5. Note your deployment URL: `https://timeline.solutions`

### Step 1.3: Connect Custom Domain
1. In Vercel dashboard → Your project → Settings → Domains
2. Add your domain: `timeline.solutions`
...
4. Update these fields:
   - **Site URL**: `https://timeline.solutions`
   - **Redirect URLs**: Add these (one per line):
     ```
     https://timeline.solutions/*
     https://timeline.solutions
     https://www.timeline.solutions/*
     http://localhost:3000/*
     ```
5. Click **Save**
...
2. Add domain: `api.timeline.solutions`
...
5. Fill in **App Domain**:
   - Application home page: `https://timeline.solutions`
   - Application privacy policy: `https://timeline.solutions/privacy`
   - Application terms of service: `https://timeline.solutions/terms`
...
2. Add property → Enter `timeline.solutions`
...
3. URL: `https://timeline.solutions/api/stripe-webhook`
...
| Service | URL |
|---------|-----|
| Production Site | `https://timeline.solutions` |
