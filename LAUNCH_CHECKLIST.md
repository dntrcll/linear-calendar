...
2. Add your domain (e.g., `api.timeline-os.com`)
3. Configure DNS:
...
```javascript
// .env.local
REACT_APP_SUPABASE_URL=https://api.timeline-os.com
```
...
2. **Complete Application Information**
   ...
   - App home page: https://timeline-os.com
   - Privacy policy: https://timeline-os.com/privacy
   - Terms of service: https://timeline-os.com/terms
